...
np.save('x_pick.npy',x)  
np.save('y_hat.npy',label)   
  

x= np.load('x_pick.npy')
...
index=np.array(np.where(label_adv==label))[0,:]
...
np.save('accuracy_WhiteAttack_Adverserial.npy',acc_adv)
